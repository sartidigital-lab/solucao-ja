...
export const metadata = {
  title: 'Conversa com Cliente — Solução Já',
};
...
export default async function ProfessionalChatRoomPage({ params }: PageProps) {
  ...
  // 1. Carregar as salas para validar acesso e obter dados do outro participante (o cliente)
